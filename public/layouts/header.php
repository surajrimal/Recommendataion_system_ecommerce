...
<?php
	...
	if(!isset($_SESSION['email'])&&isset($_SESSION['customer_name'])){
			//echo "Welcome ".$_SESSION['customer_name']." (You are not registered)<br>";
?>
	<a href="user_backend/session_display.php">View Ordered Item</a></br> 
		<a href="login/cust_logout.php">Shop as New User</a>  <br/>
...
?>
<a href="user_backend/order_display.php"><b>View My Ordered item</b></a><br>
		<a href="login/cust_logout.php"><b>Logout</b></a>       
<?php
		}else{ ?>
	<p class="clearfix"> <!--<img src="temp/img/reg.png" alt="" class="fl p3"> --> <a href="register.php"><b>Sign Up Now</b></a>
	 <!--  dropdown form start -->
		<p class="dropdown-toggle" data-toggle="dropdown"> <img src="temp/img/login.png" alt="" class="fl p3"> <a href="cabinet.php" ><b>Log In </b><strong class="caret"></strong> </a></p>
