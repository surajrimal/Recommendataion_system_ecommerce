...
<?php
	...
	<p class="clearfix"> <!--<img src="temp/img/reg.png" alt="" class="fl p3">-->  <a href="../register.php" target="_blank">Sign Up Now</a>
	 <!--  dropdown form start -->
		<p class="dropdown-toggle" data-toggle="dropdown"> <img src="temp/img/login.png" alt="" class="fl p3"> <a href="cabinet.php" target="_blank">Log In <strong class="caret"></strong> </a></p>
